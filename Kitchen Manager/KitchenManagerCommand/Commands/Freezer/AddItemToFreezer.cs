...
namespace KitchenManagerCommand.Commands.Freezer
{
    public class AddItemToFreezer
    {
        public void AddItem(Contents contents)
        {
            ...
            {
                var sql = @"INSERT INTO Freezer (ID, Name, Ounces, PurchaseDate, CreatedDate, ExpirationDate) VALUES ( @Id, @Name, @Ounces, @PurchaseDate, @CreatedDate, @ExpirationDate)";
